import sim
from time import sleep as delay# as is used to rename the function sleep to delay so that we can use delay(1) instead of sleep(1) 
import numpy as np #importing numpy library and renaming it as np so that we can use np instead of numpy 
import cv2
import sys
